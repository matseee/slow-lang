...
type Lexer struct {
	input        string
	position     int  // position in input (position of current char)
	readPosition int  // reading position in input (char after current char)
...
func (l *Lexer) NextToken() token.Token {
	...
	case '!':
		if l.peekChar() == '=' {
			tok = newTwoCharToken(token.NEQ, l)
		} else {
